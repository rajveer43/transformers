...
このモデルは、[Anahita Bhiwandiwalla](https://huggingface.co/anahita-b)、[Tiep Le](https://huggingface.co/Tile)、[Shaoyen Tseng](https://huggingface. co/シャオイェント）。元のコードは [ここ](https://github.com/microsoft/BridgeTower) にあります。
